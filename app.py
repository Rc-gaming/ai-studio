...
def admin_block():
    ...
    if username == ADMIN_USERNAME:
        ...
        return jsonify(
            {
                "error":
                    "Configured admin cannot be blocked."
            }
        ), 400
